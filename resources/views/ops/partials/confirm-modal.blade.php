<div class="ops-modal" data-ops-confirm-modal hidden>
    ...
    >
        <div class="ops-modal-header">
            <strong id="ops-confirm-title" data-ops-confirm-title>{{ __('ops.confirm.title') }}</strong>
            <button type="button" class="ops-icon-btn" data-ops-confirm-cancel aria-label="{{ __('ops.confirm.close') }}">
        ...
        <div class="ops-modal-footer">
            <button type="button" class="btn btn-ghost" data-ops-confirm-cancel>{{ __('ops.confirm.cancel') }}</button>
            <button type="button" class="btn btn-danger" data-ops-confirm-accept>{{ __('ops.confirm.accept') }}</button>
        </div>
    </div>
</div>
