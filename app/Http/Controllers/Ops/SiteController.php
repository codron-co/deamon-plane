...
class SiteController extends Controller
{
    ...
    public function store(StoreSiteRequest $request): RedirectResponse
    {
        ...
        return redirect()
            ...
            ->with('status', 'Draft site saved. Use Provision to create the Coolify compose stack.');
    }
    ...
    public function edit(Request $request, Site $site, SiteHealthEvaluator $agentHealth): View
    {
        ...
        $site->load(['primaryDomainRecord', 'themeInstallations.theme']);
        ...
        return view('ops.sites.edit', [
            ...
            'deployments' => $site->deployments()
                ...
                ->limit(25)
                ->get(),
            'coolifyAppUrl' => CoolifySetting::current()->applicationUiUrl($site->coolify_app_uuid),
    ...
    public function provision(Request $request, Site $site, SiteProvisioner $provisioner): RedirectResponse
    {
        ...
        if ($site->status === SiteStatus::Error) {
            return redirect()
                ->route('ops.sites.edit', $site)
                ->with('error', 'Provisioning failed. See the audit log. Secrets were not written to logs.');
        }
