...
return [
    ...
    'jobs' => [
        ...
        'bulk_deploy_gate' => 'Deploy kapısı',
    ...
    'activity' => [
        ...
        'actions' => [
            'site' => [
                ...
                'git_update_head' => 'HEAD’e güncellendi',
                ...
                'deploy_gate_updated' => 'Deploy kapısı değişti',
                'deploy_canary_updated' => 'Kanarya işareti değişti',
                'ci_rollout_deployed' => 'CI yayını deploy etti',
                'ci_rollout_canary_failed' => 'CI yayını: kanarya başarısız',
            ],
            'mail_server' => [
            ...
            'fleet_rollout' => [
                'started' => 'CI yayını başladı',
                'done' => 'CI yayını bitti',
                'halted' => 'CI yayını durduruldu',
                'resumed' => 'CI yayını sürdürüldü',
                'superseded' => 'CI yayınının yenisi geldi',
                'canary_failed' => 'CI yayını kanaryada durdu',
            ],
            'ci' => [
                'run_failed' => 'CI kırmızı: commit bekletildi',
                'run_superseded' => 'CI yeşil ama dal ilerlemiş',
                'run_head_unknown' => 'CI yeşil ama push kaydı yok',
            ],
            'theme' => [
                'ci_promoted' => 'Tema CI yeşil: katalog ilerledi',
                'ci_failed' => 'Tema CI kırmızı: commit bekletildi',
                'ci_held' => 'Tema CI: commit bekletildi',
                'ci_gate_updated' => 'Tema CI kapısı değişti',
            ],
        ],
    ],
];
